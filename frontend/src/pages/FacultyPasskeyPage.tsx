...
export default function FacultyPasskeyPage(): JSX.Element {
  const [mode, setMode] = useState<'email' | 'phone'>('email')
  return (
    <div className="bg-gradient-to-br from-fuchsia-300 to-indigo-400 py-10">
      <div className="mx-auto max-w-md rounded-2xl bg-white p-6 shadow-lg ring-1 ring-black/5">
        <div className="flex items-center gap-3">
          ...
          <div className="text-lg font-bold">Faculty Passkey</div>
        </div>
